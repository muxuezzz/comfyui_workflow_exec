...
class MathUtils:
    ...
    @staticmethod
    def is_overlapping(box1: Tuple[int, int, int, int], box2: Tuple[int, int, int, int], threshold: float = 0.0) -> bool:
        """
        检查两个边界框是否重叠
    ...
    @staticmethod
    def randomize_value(base_value: Union[int, float], variation_percentage: float = 0.1) -> Union[int, float]:
        """
        在基准值基础上随机化
